...
LEFT_UNDER = False          #Ultrasonic sensor variable to make robot aligned with table edge. 
RIGHT_UNDER = False         #False if ultrasonic sensor doesn't detect anything, True if detects
